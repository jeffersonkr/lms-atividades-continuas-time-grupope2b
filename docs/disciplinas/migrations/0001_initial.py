    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idprofessor', models.ForeignKey(db_column='IdProfessor', on_delete=django.db.models.deletion.DO_NOTHING, to='professores.Professor')),
            ],
            options={
                'db_table': 'Atividade',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(db_column='Nome', max_length=80, unique=True)),
                ...
                ('ementa', models.CharField(db_column='Ementa', max_length=100)),
                ('conteudoprogramatico', models.CharField(db_column='ConteudoProgramatico', max_length=100)),
                ...
                ('idcoordenador', models.ForeignKey(db_column='IdCoordenador', on_delete=django.db.models.deletion.DO_NOTHING, to='coordenadores.Coordenador')),
            ],
            options={
                'db_table': 'Disciplina',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idcurso', models.ForeignKey(db_column='IdCurso', on_delete=django.db.models.deletion.DO_NOTHING, to='cursos.Curso')),
                ...
                ('idprofessor', models.ForeignKey(blank=True, db_column='IdProfessor', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='professores.Professor')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='atividadevinculada',
            name='idprofessor',
            field=models.ForeignKey(db_column='IdProfessor', on_delete=django.db.models.deletion.DO_NOTHING, to='professores.Professor'),
        ),
    ]
