...
class Disciplina(models.Model):
    ...
    habilidades = models.CharField(db_column='Habilidades', max_length=200)  # Field name made lowercase.
    ementa = models.CharField(db_column='Ementa', max_length=200)  # Field name made lowercase.
    conteudoprogramatico = models.CharField(db_column='ConteudoProgramatico', max_length=200)  # Field name made lowercase.
    bibliografiabasica = models.CharField(db_column='BibliografiaBasica', max_length=200)  # Field name made lowercase.
    bibliografiacomplementar = models.CharField(db_column='BibliografiaComplementar', max_length=200)  # Field name made lowercase.
